...
(chart = new ApexCharts(document.querySelector("#earning-item"),option)).render(),
Chart.pluginService.register({
    ...
    afterDraw: function(e) {
        for (var r = 1; r < e.config.data.labels.length; r++) {
            ...
            t.beginPath(),
            t.arc(arc.round.radius * Math.sin(a), arc.round.radius * Math.cos(a), arc.round.thickness, 0, 2 * Math.PI),
            t.closePath(),
            t.fill(),
            t.restore()
        }
